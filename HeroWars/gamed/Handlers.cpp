...
{
	uint8 heroSpawn[] = {0xff, 0x06, 0x07, 0x66, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfe, 0x50, 0x00, 0xba, 0x19, 0x00,\
...
uint8 turrets4[] = {0xff, 0x07, 0x4f, 0xa6, 0x13, 0x00, 0x00, 0x40, 0x13, 0x00, 0x00, 0x40, 0x40, 0x54, 0x75, 0x72,\
	...
	sendPacket(peer, reinterpret_cast<uint8*>(heroSpawn), sizeof(heroSpawn), 3);
...
bool PacketHandler::handleView(ENetPeer *peer, ENetPacket *packet)
{
	...
	return sendPacket(peer, reinterpret_cast<uint8*>(&answer), sizeof(ViewAns), 3);
}
